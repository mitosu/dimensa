...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="Web de empresa de transporte en Madrid, mensajería urgente, paquetería">
    ...
    <body>
        ...
        <div id="contenido" class="container"><!--Contenido-->
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <?php include ('footer_zona_clientes.php');?>
                </div>
                <div class="col-md-4">
                    <?php include ('footer_contactar.php');?>
                </div>
            </div>
